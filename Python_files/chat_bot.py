...
summarizer_prompt = ChatPromptTemplate.from_messages(
    [
        SystemMessage(
            ...
            Текст должен быть сжатым. Пиши от неопредлённого лица. 
            Не используй в тексте слова пациент. Например, вместо "Пациент жалуется на трёхдневную боль в горле" или
